    ...
    if request.method == 'POST':
        ...
        if level == school.level:
            if request.session['hint']:
                ...
                return render(request, 'cluehunt/puzzle.html', {'resources': puzzle.resources, 'error': False, 'level': level, 'hintsLeft': school.hintsLeft, 'skipsLeft': school.skipsLeft, 'hints': puzzle.hints, 'hintNumber': puzzle.hintNumber, 'title': puzzle.title})
            else: 
